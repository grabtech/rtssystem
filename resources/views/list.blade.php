                                ...
                                <table id="datatablesSimple">
                                    ...
                                    @foreach($ticketData as $ticketData)
                                        <tr>
                                            ...
                                            <td>
                                                <select id="{{$ticketData->id}}" class="form-control input-lg" onchange="updatestatus(this,'{{$ticketData->id}}')" style="color:white; <?php if($ticketData->status==1) { echo 'background:#b02a37 ;';} elseif($ticketData->status==0){ echo 'background: #146c43;';} else{echo 'background: #4682B4;';}?>" >
